    ...
    const getLocation = useCallback(async () => {
        try {
            const response = await axios.get(
                `https://rsapi.goong.io/Geocode?api_key=uGwlo6yHxKnoqSPqp0Enla92wOd1YpmpbYrEy3GK&latlng=${coord.latitude},${coord.longitude}`
            );
                            ...
                            <View style={styles.origin_address}>
                                <View>
                                    <View style={styles.origin_title}>
                                        ...
                                        <Text style={styles.t_origin}>
                                            Địa điểm lấy hàng
                                        </Text>
                                    </View>
                                    <Text style={styles.t_origin_address}>
                                        {' '}
                                        {address}
                                    </Text>
                                </View>
                        ...
                        <TouchableOpacity onPress={onClickPlaceDelivery}>
                            <View style={styles.destination_address}>
                                <Icon2
                                    ...
                                    color={'orange'}
                                />
                                <Text style={styles.destination_title}>
